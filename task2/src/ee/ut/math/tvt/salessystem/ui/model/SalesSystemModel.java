...
public class SalesSystemModel {
    ...
    public void refreshTableModel(int tabIndex){
    	if (tabIndex == 0) currentPurchaseTableModel.refresh();
    	else if (tabIndex == 1) warehouseTableModel.refresh();
    	else if (tabIndex == 2) purchaseHistoryTableModel.refresh();
    	else if (tabIndex == 3) clientTableModel.refresh();
